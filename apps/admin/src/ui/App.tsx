  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-start justify-between gap-4">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.35em] text-slate-600 dark:text-slate-300">{title}</p>
        ...
        <motion.div
          className="grid h-12 w-12 place-items-center rounded-2xl bg-white/70 text-slate-600 shadow-inner dark:bg-white/10 dark:text-white/90"
          whileHover={{ rotate: 6 }}
        >
...
const QuickActionCard = ({ title, description, icon: Icon, tone, theme }: QuickAction & { theme: 'light' | 'dark' }) => (
  ...
  >
    ...
    />
    <div className="relative z-10 flex items-center gap-2 text-xs uppercase tracking-[0.25em]">
          ...
          <main className="flex flex-1 flex-col gap-8">
            ...
            >
              <div>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-3 text-2xl font-semibold">
                  Painel
                  <span className="rounded-full border border-slate-200/70 bg-white/80 px-3 py-1 text-xs font-medium text-slate-600 backdrop-blur-sm dark:border-white/10 dark:bg-white/10 dark:text-slate-200">
              ...
              >
                ...
                <span className="relative flex items-center gap-3 px-2">
                  <motion.span
                    ...
                    className="grid h-9 w-9 place-items-center rounded-full bg-white/90 text-slate-700 shadow-inner shadow-white/40 dark:bg-white/10 dark:text-white/90"
                  >
                    {theme === 'light' ? <Moon className="h-4 w-4" /> : <Sun className="h-4 w-4" />}
                  </motion.span>
                  <span className="flex flex-col text-left">
                    <span>{theme === 'light' ? 'Modo escuro' : 'Modo claro'}</span>
                    <span className="text-[10px] font-medium uppercase tracking-[0.32em] text-slate-400 dark:text-slate-300">
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <span className="rounded-full border border-slate-200/60 bg-white/80 px-3 py-1 text-xs font-semibold text-slate-600 backdrop-blur-sm dark:border-white/10 dark:bg-white/10 dark:text-slate-200">
            ...
            <section className="grid gap-5 xl:grid-cols-2">
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <p className="text-sm font-semibold text-slate-600 dark:text-slate-200">Insights da IA</p>
                  <span className="rounded-full border border-slate-200/60 bg-white/70 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.35em] text-slate-400 dark:border-white/10 dark:bg-white/10 dark:text-slate-300">
                    Atualizado agora
                  </span>
                </div>
                <div className="mt-3 space-y-3 text-sm leading-relaxed text-slate-600 dark:text-slate-200">
                  <p>
            ...
            <footer className="relative mt-10 border-t border-slate-200/60 pt-6 text-xs text-slate-400 dark:border-white/10 dark:text-slate-500">
