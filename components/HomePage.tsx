    ...
    <div className="h-screen w-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl w-full mx-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Link
            href="/golffox"
            className="bg-red-600 hover:bg-red-700 text-white p-6 rounded-lg text-center transition-colors duration-200 block"
          >
            <div className="text-xl font-semibold mb-2">Painel da Golffox</div>
            <div className="text-sm opacity-90">Sistema administrativo completo</div>
          </Link>
          ...
          >
            <div className="text-xl font-semibold mb-2">Painel da Transportadora</div>
            <div className="text-sm opacity-90">Sistema de gestão para transportadoras</div>
          </Link>
