...
import { DashboardIcon, MapIcon, RouteIcon, AlertIcon, ReportIcon, TruckIcon, UserCircleIcon, LifebuoyIcon, BuildingOfficeIcon, AdjustmentsHorizontalIcon, ClockIcon, CurrencyDollarIcon } from '../../../components/icons/Icons';
  ...
  return (
    <aside className="w-64 bg-golffox-blue-dark text-white p-6 flex flex-col shadow-lg h-full">
      <div className="flex items-center mb-10">
        <Image src="/golffox-logo.svg" alt="Golffox Logo" width={48} height={48} className="h-12" />
      </div>
      <nav>
        <ul>
          <NavItem
